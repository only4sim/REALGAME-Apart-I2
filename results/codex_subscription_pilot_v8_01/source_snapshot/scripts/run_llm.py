...
import argparse, copy, datetime, hashlib, json, math, os, random, sys, threading, time
...
def parse_obj(text):
    ...
    def unique_keys(pairs):
        ...
        for key, value in pairs:
            ...
            obj[key] = value
        return obj
    obj=json.loads(text, parse_constant=reject_constant, parse_float=finite_float, object_pairs_hook=unique_keys)
